...
use MaarchCourrier\Tests\Functional\Core\Error\Mock\StubLangProblem;
...
class ErrorHandlerTest extends CourrierTestCase
{
    ...
    public function testProblemSerializationIncludesLangWhenNotNull(): void
    {
        $environmentMock = new EnvironmentMock();

        $errorHandler = new ErrorHandler($environmentMock);

        $exception = new StubLangProblem('toto');
