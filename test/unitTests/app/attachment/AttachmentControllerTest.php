...
{
    private static ?int $originalAttachmentId = null;
    private static ?int $versionAttachmentId = null;
    private static ?int $originalResponseProjectId = null;
    private static ?int $signedAttachmentId = null;
    ...
    public function testCreate()
    {
        ...
        $response = $attachmentController->create($fullRequest, new Response());
        $responseBody = json_decode((string)$response->getBody());
        self::$originalResponseProjectId = $responseBody->id;
        $this->assertIsInt(self::$originalResponseProjectId);
        ...
        $args = [
            ...
            'encodedFile' => $encodedFile,
            'format'      => 'txt',
            'originId'    => self::$originalResponseProjectId,
            'status'      => 'TRA'
        ];
        ...
        $this->assertIsInt(self::$signedAttachmentId);
    }
    ...
    public function testUpdate()
    {
        ...
        $responseBody = json_decode((string)$response->getBody(), true);
        $this->assertSame(
            'Only attachment with status "A_TRA", "TRA" or "SEND_MASS" can be edited. Current status is OBS',
            $responseBody['errors']
        );
        $this->assertSame(400, $response->getStatusCode());

        $response = $attachmentController->update(
            $fullRequest,
            new Response(),
            ['id' => self::$versionAttachmentId * 1000]
        );
        $responseBody = json_decode((string)$response->getBody(), true);
    ...
    public function testGetThumbnailContent()
    {
        ...
        $response = $attachmentController->getThumbnailContent(
            $request,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
    ...
    public function testGetThumbnailContentByPage()
    {
        ...
        $response = $attachmentController->getThumbnailContentByPage(
            $request,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
    ...
    public function testGetOriginalFileContent()
    {
        ...
        $response = $attachmentController->getOriginalFileContent(
            $request,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
        $headers = $response->getHeaders();
        $this->assertSame(
            'attachment; filename=La plus chétive cabane renferme plus de vertus que les palais des rois._V2.txt',
        ...
        $this->assertSame(
            'La plus chétive cabane renferme plus de vertus que les palais des rois._V2.txt',
    ...
    public function testGetFileContent()
    {
        ...
        $response = $attachmentController->getFileContent(
            $fullRequest,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
        ...
        $response = $attachmentController->getFileContent(
            $request, new Response(), ['id' => self::$versionAttachmentId]
        );
        $responseBody = json_decode((string)$response->getBody(), true);
        $this->assertSame('Document out of perimeter', $responseBody['errors']);
        $this->assertSame(403, $response->getStatusCode());
    ...
    public function testEncodedDocument()
    {
        ...
        // GET
        $response = $attachmentController::getEncodedDocument(
            ['id' => self::$versionAttachmentId, 'original' => false]
        );
        $this->assertNotEmpty($response['encodedDocument']);
    }
    ...
    public function testMailing()
    {
        ...
        // ERROR
        $response = $attachmentController->getMailingById(
            $request, new Response(), ['id' => self::$versionAttachmentId]
        );
        $response = json_decode((string)$response->getBody(), true);
    ...
    public function testSetInSignatureBook()
    {
        ...
        $response = $attachmentController->setInSignatureBook(
            $request,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
    ...
    public function testSetInSendAttachment()
    {
        ...
        $response = $attachmentController->setInSendAttachment(
            $request,
            new Response(),
            ['id' => self::$versionAttachmentId]
        );
     ...
     * @throws Exception
     */
    public function testSetInSendSignedAttachment()
    {
        $attachmentController = new AttachmentController();
        ...
        $response = $attachmentController->setInSendAttachment(
            $request,
            new Response(),
            ['id' => self::$originalResponseProjectId]
        );
    ...
    public function testDelete()
    {
        ...
        $response = $attachmentController->delete($request, new Response(), ['id' => self::$signedAttachmentId]);
        $this->assertSame(204, $response->getStatusCode());

        $response = $attachmentController->delete($request, new Response(), ['id' => self::$originalResponseProjectId]);
        $this->assertSame(204, $response->getStatusCode());
