...
class VersionUpdateControllerTest extends CourrierTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        copy(
            $sampleMigrationFolderPath . '/1-TestErrorTypoInUpdate.php',
            self::$nextMigrationFolderPath . '/1-TestErrorTypoInUpdate.php'
        );
        copy(
            $sampleMigrationFolderPath . '/2-TestErrorTypoInRollback.php',
    ...
    public function testGet()
    {
        ...
        if ($responseBody->lastAvailableMinorVersion != null) {
            ...
            $this->assertMatchesRegularExpression(
                '/^\d{4}\.\d\.\d+$/',
                $responseBody->lastAvailableMinorVersion,
                'Invalid available minor version'
            );
        }
        ...
        if ($responseBody->lastAvailableMajorVersion != null) {
            ...
            $this->assertMatchesRegularExpression(
                '/^\d{4}\.\d\.\d+$/',
                $responseBody->lastAvailableMajorVersion,
                'Invalid available major version'
            );
        }
    }
    ...
    public function testAutoUpdateLauncherWithSomethingToMigrateExpectSuccessCode200AndDatabaseUpdated()
    {
        // Arrange
        $versionUpdateController = new VersionUpdateController();
    ...
    public function testAutoUpdateLauncherWithNothingToMigrateExpectSuccessCode204()
    {
        // Arrange
        $versionUpdateController = new VersionUpdateController();
    ...
    public function provideDatabaseVersionFormats(): array
    {
        return [
            '2301.1 Format'     => [
                'input' => '2301.1'
     ...
     */
    public function testAvailableFoldersWithDatabaseVersionFormatThatDoesNotHaveThreeDotsExpectBadFormatDatabaseVersion(
        $input
    ) {
        // Arrange
    ...
    public function testAvailableFoldersWithAvailableFolderIsEmptyExpectError()
    {
        ...
        $this->assertNotEmpty($availableFolders['errors']);
        $this->assertSame(
            $availableFolders['errors'],
            "Folder '" . self::$availableTestFolder . "' is empty, no updates are found!"
        );
    }
