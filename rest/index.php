...
$app->get('/signatureBook/version', \MaarchCourrier\SignatureBook\Infrastructure\Controller\GetSignatureBookServiceVersionController::class . ':getVersion');
...
$app->get('/parameters/nextcloud/check', \Parameter\controllers\ParameterController::class . ':check');
// EDISSYUM - AMO01

// EDISSYUM - ASY01 Implémentation envoie de Mail sécurisé via Pastell
$app->get('/parameters/pastell/check', \Parameter\controllers\ParameterController::class . ':checkPastell');
// END EDISSYUM - ASY01
...
$app->get('/lexPersona/getUser/{resId}', \ExternalSignatoryBook\controllers\LexPersonaController::class . ':getOrganizations');
$app->post('/lexPersona/retrieveDocuments', \ExternalSignatoryBook\controllers\LexPersonaController::class . ':retrieveDocuments');
// END EDISSYUM - YAA01

// EDISSYUM - YAA01 Ajout du connecteur SESILE
$app->get('/sesile/getDatas', \ExternalSignatoryBook\controllers\SesileController::class . ':getDatas');
// END EDISSYUM - YAA01

// EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
$app->post('/resourcesList/exports/models', \Resource\controllers\ExportController::class . ':createModel');
$app->get('/resourcesList/exportModels', \Resource\controllers\ExportController::class . ':getModelsByUserId');
$app->delete('/resourcesList/exportModels/{id}', \Resource\controllers\ExportController::class . ':deleteModel');
$app->put('/resourcesList/exportModelsEntity/{id}', \Resource\controllers\ExportController::class . ':updateModelEntity');
$app->get('/resourcesList/allExportModels', \Resource\controllers\ExportController::class . ':getModels');
$app->put('/resourcesList/exportModels/{id}', \Resource\controllers\ExportController::class . ':updateModel');
$app->get('/resourcesList/exportModels/{id}', \Resource\controllers\ExportController::class . ':getModelById');

$app->get('/resources/{resId}/annotation', \Resource\controllers\ExportController::class . ':getAnnotations');
$app->get('/resources/{resId}/difusionsList', \Resource\controllers\ExportController::class . ':getDifusionsList');
$app->get('/resources/{resId}/sendersFiche', \Resource\controllers\ExportController::class . ':getSendersFiche');
$app->get('/resources/{resId}/recipientsFiche', \Resource\controllers\ExportController::class . ':getRecipientsFiche');
// END EDISSYUM - ASY01

// EDISSYUM - EME01 Ajout du connecteur Neocity
$app->post('/webhookReporting', \Resource\controllers\ResController::class . ':handleWebHookReporting');
// END EDISSYUM - EME01

$app->put('/res/externalId', \Resource\controllers\ResController::class . ':updateExternalId'); // EDISSYUM - NCH01 Rajout d'une route pour update un external_id

// EDISSYUM - NCH01 Implémentation SerenIA
$app->get('/serenia/enabled', \Serenia\controllers\SereniaController::class . ':isEnabled');
$app->post('/serenia/chatbot', \Serenia\controllers\SereniaController::class . ':askChatbot');
// END EDISSYUM - NCH01

$app->get('/database/select', \DatabaseQuery\controllers\DatabaseQueryController::class . ':getData'); // EDISSYUM - AMO01 Route webservice pour récupérer des données dans la BDD
