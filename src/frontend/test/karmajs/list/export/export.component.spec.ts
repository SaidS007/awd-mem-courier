...
describe('ExportComponent', () => {
    ...
    providers: [
        ...
        PrivilegeService,
        DatePipe,
        { provide: SortPipe, useClass: SortPipe },
        { provide: NotificationService, useValue: { notify: jasmine.createSpy('notify') } },
        { provide: FunctionsService, useValue: { empty: jasmine.createSpy('empty').and.returnValue(true) } },
        { provide: HeaderService, useValue: {} },
        { provide: MatDialog, useValue: { open: jasmine.createSpy('open') } },
        { provide: HttpClient, useValue: { get: jasmine.createSpy('get'), post: jasmine.createSpy('post') } },
