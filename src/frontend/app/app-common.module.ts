...
import { SereniaChatbotComponent } from '@plugins/serenia-chatbot/serenia-chatbot.component'; // EDISSYUM - NCH01 Implémentation SerenIA
...
@NgModule({
    ...
    declarations: [
        ...
        SereniaChatbotComponent, // EDISSYUM - NCH01 Implémentation SerenIA
    ],
    exports: [
        CommonModule,
        MenuNavComponent,
