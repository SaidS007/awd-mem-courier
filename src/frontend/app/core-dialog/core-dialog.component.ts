...
import { Title } from '@angular/platform-browser'; // EDISSYUM - NCH01 Changer le titre de la page avec le nom de l'application
...
export class CoreDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private serviceTitle: Title // EDISSYUM - NCH01 Changer le titre de la page avec le nom de l'application
    ) {
            ...
            this.http
                ...
                .pipe(
                    tap((data: any) => {
                        ...
                        this.serviceTitle.setTitle(this.authService.applicationName); // EDISSYUM - NCH01 Changer le titre de la page avec le nom de l'application
                        ...
                        this.headerService.plugins = data.plugins;
    ...
    setIconLogo() {
        this.iconReg.addSvgIcon('memLogo', this.sanitizer.bypassSecurityTrustResourceUrl('../rest/images?image=onlyLogo'));
        this.iconReg.addSvgIcon('memLogoFull', this.sanitizer.bypassSecurityTrustResourceUrl('../rest/images?image=logo'));
    }
}
