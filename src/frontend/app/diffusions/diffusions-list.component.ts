...
export class DiffusionsListComponent implements OnInit {
    ...
    @Input() noDiffusionRole: boolean = false; // EDISSYUM - NCH01 Ajout d'un paramètre pour ne pas remonter les rôles de diffusion dans l'indexation
