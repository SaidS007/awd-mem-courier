...
export class CustomizationComponent implements OnInit {
    ...
    constructor(
        ...
        const tutorialUrl: string = this.functionsService.getTutorialBaseUrl(); // EDISSYUM - AMO01 Changement du message de bienvenue

        this.stepFormGroup = this._formBuilder.group({
            firstCtrl: ['success', Validators.required],
            customId: [null, valIdentifier],
            appName: [`MEM Courrier ${environment.BASE_VERSION}`, Validators.required], // EDISSYUM - NCH01 Changement du nom d'application
            loginMessage: [`<span style="color:#3A7C00"><strong>Découvrez votre application via</strong></span>&nbsp;<a title="le guide de visite" href="${docUrl}" target="_blank"><span style="color:#C25712;"><strong>le guide de visite en ligne</strong></span></a>`], // EDISSYUM - NCH01 Changement des URL de documentations | Supprimer /guu/home.html
            homeMessage: [`<p>Bienvenue sur <strong>MEM Courrier ${environment.BASE_VERSION}.</strong><br/> Suivez le <a title="guide de visite en ligne" href="${docUrl}" target="_blank"><span style="color:#FFFD94;"><strong>guide de visite en ligne</strong></span></a>.<br/> Visitez nos <a title="Tutoriels MEM Courrier" href="${tutorialUrl}" target="_blank"><span style="color:#FFFD94;"><strong>tutoriels MEM courrier</strong></span></a>.</p>`], // EDISSYUM - NCH01 Changement du nom d'application // EDISSYUM - AMO01 Changement du message de bienvenue
