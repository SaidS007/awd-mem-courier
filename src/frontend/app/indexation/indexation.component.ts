        ...
        if (this.indexingForm.isValidForm() && this.appIndexationAttachmentsList.isValid()) {
            ...
            this.appDocumentViewer.getFile().pipe(
                ...
                tap((data: any) => {
                    ...
                    // EDISSYUM - NCH01 Correction publipostage | Commenter la ligne ci-dessous
                    ...
                    // EDISSYUM - NCH01 Correction publipostage
                    this.isMailing = !this.functions.empty(formatdatas.recipients) && formatdatas.recipients.length > 0 && formatdatas['encodedFile'] === null;
                    // END EDISSYUM - NCH01
