...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            { path: 'administration/registeredMails/sites', canActivate: [AppGuardAdmin], component: IssuingSiteListComponent },
            { path: 'administration/registeredMails/sites/new', canActivate: [AppGuardAdmin], component: IssuingSiteComponent },
            { path: 'administration/registeredMails/sites/:id', canActivate: [AppGuardAdmin], component: IssuingSiteComponent },
            ...
            { path: 'administration/contacts/search', canActivate: [AppGuardAdmin], component: ContactSearchAdministrationComponent }, // EDISSYUM - NCH01 Fenetre de recherche de contacts
            { path: 'administration/folders', canActivate: [AppGuardAdmin], component: FoldersAdministrationComponent }, // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
