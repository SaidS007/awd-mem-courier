...
export class ParametersCustomizationComponent implements OnInit, OnDestroy {
    ...
    initMce(readonly = false) {
        const param = {
            ...
            readonly: readonly,
            plugins: [
                'autolink', 'table', 'autoresize', 'link' // EDISSYUM - NCH01 Changement des URL de documentations | Ajout du plugin link
            ],
            ...
            toolbar: !readonly ? 'undo redo | link | fontselect fontsizeselect | bold italic underline strikethrough forecolor | table maarch_b64image | \
        alignleft aligncenter alignright alignjustify \
        bullist numlist outdent indent | removeformat' : '' // EDISSYUM - NCH01 Changement des URL de documentations | Ajout de link
        };
        tinymce.init(param);
