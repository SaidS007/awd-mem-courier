...
import { HeaderService } from '@service/header.service'; // EDISSYUM - NCH01 Rajout de la possibilité de visualiser les contacts sans droits d'administration
...
export class ContactsFormComponent implements OnInit {
    ...
    contactForm: any[] = [
        ...
        },
        {
            ...
            desc: `${this.translate.instant('lang.userIdm2mDesc')}`,
            type: 'string',
            control: new UntypedFormControl(),
            required: false,
            display: false,
        ...
        },
        {
            ...
            desc: `${this.translate.instant('lang.userPasswordm2mDesc')}`,
            type: 'string',
            control: new UntypedFormControl(),
            required: false,
            display: false,
    ...
    constructor(
        ...
        private headerService: HeaderService // EDISSYUM - NCH01 Rajout de la possibilité de visualiser les contacts sans droits d'administration
    ...
    ngOnInit(): void {
        ...
        this.headerService.user.privileges.forEach((element: any) => {
            if (element === 'admin_contacts' || element === 'update_contacts') {
                adminContact = true;
            }
        });
