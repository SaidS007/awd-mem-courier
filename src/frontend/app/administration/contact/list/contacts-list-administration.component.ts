...
import { PrivilegeService } from "@service/privileges.service"; // EDISSYUM - NCH01 Rajout de la possibilité de visualiser les contacts sans droits d'administration
...
export class ContactsListAdministrationComponent implements OnInit {
    ...
    constructor(
        ...
        public privilegeService: PrivilegeService // EDISSYUM - NCH01 Rajout de la possibilité de visualiser les contacts sans droits d'administration
    ) {
        ...
        merge(this.sort.sortChange, this.paginator.page, this.filtersChange)
            .pipe(
                ...
                map(data => {
                    ...
                    // EDISSYUM - NCH01 Rajout de la possibilité de visualiser les contacts sans droits d'administration
                    if (!this.showSubMenu) {
                        this.headerService.setHeader(this.translate.instant('lang.adminContactReadOnly'))
                    }
                    // END EDISSYUM - NCH01
