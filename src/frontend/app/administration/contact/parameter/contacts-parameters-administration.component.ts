...
export class ContactsParametersAdministrationComponent implements OnInit {
    ...
    displayedColumns = ['label', 'mandatory', 'filling', 'searchable', 'displayable','filtrable', 'exportable']; // EDISSYUM - NCH01 Fenetre de recherche de contacts | ajout de filtrable && ASY01 Ajout de modèle d'exportation PDF/CSV | Ajout de exportable
    ...
    constructor(
        ...
        //EDISSYUM - LBE01 Fix affichage menu adminsitration des contacts
