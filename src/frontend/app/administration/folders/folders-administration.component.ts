...
export class FoldersAdministrationComponent implements OnInit {
    ...
    availableData: any = [
        ...
        },
        {
            ...
            'sample': '<i style="color:#006841" class="fa fa-check"></i> Barbara BAIN -> <i class="fa fa-hourglass-half"></i> <b>Bruno BOULE</b> -> <i class="fa fa-hourglass-half"></i> Patricia PETIT',
            'cssClasses': ['align_leftData'],
            'icon': 'fa-list-ol'
        },
        {
    ...
    drop(event: CdkDragDrop<string[]>) {
        if (event.previousContainer === event.container) {
            moveItemInArray(this.displayedSecondaryData, event.previousIndex, event.currentIndex);
        } else {
