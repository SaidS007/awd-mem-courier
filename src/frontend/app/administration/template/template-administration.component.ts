    ...
    initMce(selectorId: string) {
        setTimeout(() => {
            ...
            tinymce.init({
                ...
                // language_url: `../dist/tinymce-i18n/langs/${this.translate.instant('lang.langISO').replace('-', '_')}.js`, // EDISSYUM - LBE01 Correction traductions TinyMCE | commenter la ligne
