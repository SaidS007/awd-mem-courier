...
export class HeaderRightComponent implements OnInit {
    ...
    quickSearchTargets: any[] = [
        ...
        {
            id: 'multiCriteria',
            label: this.translate.instant('lang.multiCriteria'),
            desc: this.translate.instant('lang.multiCriteriaDesc'),
            icon: 'fas fa-magnifying-glass fa-2x',
        },
        // END EDISSYUM - NCH01
        {
            id: 'searchTerm',
    ...
    selectedQuickSearchTarget: string = 'multiCriteria'; // EDISSYUM - NCH01 Rajout d'une recherche multi-critère | Remplacer searchTerm par multiCriteria
