...
} from './actions/send-external-signatory-book-action/maarch-paraph/signature-position/signature-position.component';
import {
    DateOptionModalComponent
} from './actions/send-external-signatory-book-action/maarch-paraph/signature-position/dateOption/date-option-modal.component';
import { IParaphComponent } from './actions/send-external-signatory-book-action/i-paraph/i-paraph.component';
import {
    IxbusParaphComponent
} from './actions/send-external-signatory-book-action/ixbus-paraph/ixbus-paraph.component';
...
} from './actions/avis-give-parallel-action/give-avis-parallel-action.component';
import {
...
} from './actions/print-deposit-list-action/print-deposit-list-action.component';
import {
...
} from './search/criteria-tool/search-template/search-template-modal.component';
...
import {
    BluewayParaphComponent
} from './actions/send-external-signatory-book-action/blueway-paraph/blueway-paraph.component'; // EDISSYUM - PYB01 Ajout du connecteur Blueway
import {
    PastellParaphComponent
} from './actions/send-external-signatory-book-action/pastell-paraph/pastell-paraph.component';
import { ContactSearchComponent } from "@appRoot/contact/search/contact-search.component";
...
import { ContactsCriteriaSearchService } from "@service/contactsCriteriaSearch.service"; // EDISSYUM - PYB01 Ajout du connecteur Pastell
import { LexPersonaComponent } from './actions/send-external-signatory-book-action/lex-persona/lex-persona.component'; // EDISSYUM - YAA01 Ajout du connecteur LexPersona
import {
    AddExportCreateTemplateModalComponent
} from './list/export/export-create-template/export-create-template-modal.component'; // EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
import { ExportShareTemplateComponent } from './list/export/export-share-template/export-share-template.component'; // EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
import {
    SesileParaphComponent
} from './actions/send-external-signatory-book-action/sesile-paraph/sesile-paraph.component'; // EDISSYUM - YAA01 Ajout du connecteur SESILE
...
@NgModule({
    declarations: [
        ...
        LexPersonaComponent, // EDISSYUM - YAA01 Ajout du connecteur LexPersona
        AddExportCreateTemplateModalComponent, // EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
        ExportShareTemplateComponent, // EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
        SesileParaphComponent, // EDISSYUM - YAA01 Ajout du connecteur SESILE
    ],
    exports: [
        SharedModule
    ],
