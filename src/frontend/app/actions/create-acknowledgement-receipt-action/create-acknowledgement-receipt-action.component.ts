    ...
    downloadAcknowledgementReceipt(data: any) {
        ...
        this.http.post('../rest/acknowledgementReceipts', { 'resources': data }, { responseType: 'blob' })
            .subscribe((dataFile) => {
                ...
                downloadLink.setAttribute('download', this.functions.getFormatedFileName('acknowledgement_receipt_mem', 'pdf'));
