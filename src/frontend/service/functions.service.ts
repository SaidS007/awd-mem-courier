...
export class FunctionsService {
    ...
    getFormatedFileName(filename: string = 'mem', ext: string = '', format: string = 'dd-MM-yyyy') { // EDISSYUM - NCH01 Changement du nom d'application | Remplacer maarch par mem
    ...
    getDocBaseUrl() {
        // return `https://docs.maarch.org/gitbook/html/MaarchCourrier/${environment.BASE_VERSION}`; // EDISSYUM - NCH01 Changement des URL de documentations | Commenter cette ligne
        return 'https://edissyum.gitbook.io/guide-de-visite-mem-courrier/'; // EDISSYUM - NCH01 Changement des URL de documentations
    }

    // EDISSYUM - AMO01 Changement du message de bienvenue
    getTutorialBaseUrl() {
        return 'https://youtube.com/playlist?list=PLgJt_0-l_q8CiD_jd1-oTM96vnN2ccZbI&si=X-lzhdCLzWjXPpZ5';
    }
    // END EDISSYUM
