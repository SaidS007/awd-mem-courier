    ...
    tour: any[] = [
        {
            type: 'welcome',
            stepId: 'welcome',
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.welcomeTourTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.admin_email_serverTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.emailTourTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.admin_notifTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.notifTour2Title')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.createScriptTourTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.notifTourTitle')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.notifTour3Title')}</b>`,
        ...
        },
        {
            ...
            title: `<i class="far fa-question-circle" style="color:#3A7C00"></i>&nbsp;<b style="color:#3A7C00">${this.translate.instant('lang.notifTour4Title')}</b>`,
