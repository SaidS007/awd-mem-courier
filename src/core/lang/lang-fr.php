...
define('_SUMMARY_SHEET_CREATION', 'Création fiche de liaison'); // EDISSYUM - AMO01 Dissocier les annotations par type + Adapter le paramètre defaultStatusSummarySheet
...
// EDISSYUM - AMO01 Dissocier les annotations par type + Adapter le paramètre defaultStatusSummarySheet
define('_GLOBAL_NOTES_COMMENT', 'Annotations globales');
define('_VISA_NOTES_COMMENT', 'Annotations de visa');
define('_AVIS_NOTES_COMMENT', 'Annotations d\'avis');
// END EDISSYUM - AMO01
...
define("_NOTIFICATIONS_FORGOT_PASSWORD_SUBJECT", "[MEM Courrier] Demande de réinitialisation de mot de passe");
define(
    "_NOTIFICATIONS_FORGOT_PASSWORD_BODY",
    "Bonjour,<br/><br/>Vous avez demandé à retrouver le mot de passe d'accès à votre compte MEM Courrier.<br/>
...
define("_NOTIFICATIONS_USER_CREATION_SUBJECT", "[MEM Courrier] Activer votre compte utilisateur");
define(
    "_NOTIFICATIONS_USER_CREATION_BODY",
    "Bienvenue,<br/><br/>Vous disposez maintenant d'un compte dans l'application de gestion 
électronique de courrier MEM Courrier.<br/><br/>Pour vous connecter et définir votre mot 
...
define("_EXTERNALID_M2M_VALIDATOR", "L'identifiant MEM2MEM doit être au format SIRET/entityId");
...
define('_PESV2_RESOURCE', 'Export PESv2');
define('_PESV2_RESOURCE_DESC', 'Exporter un fichier vers un dossier réseau');
define("_EXPORT_DOC", "Export de document(s)");

define("_TMP_FILE_ERROR", "Le fichier temporaire n'existe pas");
define ("_ERROR_WHILE_RETRIEVING_FILE", "Erreur lors de la récupération du fichier, ce dernier n'existe pas ou n'est pas au format PDF");
define ("_ERROR_WHILE_RETRIEVING_ATTACHMENT_FILE", "Erreur lors de la récupération des informations de la pièce jointe sur le docserver");

define("_COPY_ERROR", "Erreur lors de la copie du fichier dans le repertoire de destination");
define("_ATTACHMENT_COPY_ERROR", "Erreur lors de la copie de la pièce jointe dans le repertoire de destination");
define("_STATUS_ERROR", "Le statut ne correspond pas à celui paramétré dans l'application");
define ("_PATH_ERROR", "Le dossier de destination n'est pas accessible");

define ("_N°", "n°");
define("_WITH_SUCCESS", "effectué avec succès");
define("_ERROR_CREATING_ZIP", "Erreur lors de la création du fichier zip");
define("_CONFIG_FILE_ERROR", "Erreur lors de la récupération des informations de configuration");
// END EDISSYUM - NCH01



// EDISSYUM - NCH01 Rajout de la confidentialité des contacts
define('_CONFIDENTIALITY', 'Coordonnées confidentielles');
// END EDISSYUM - NCH01

// EDISSYUM - ASY01 Ajout de modèle d'exportation PDF/CSV
define('_EXPORT_MODEL_MODIFICATION', "Modifier les entités du model export");
define('_TO_CIVILITY', "Civilité");
define('_TO_FIRSTNAME', "Prénom");
define('_TO_LASTNAME', "Nom");
define('_TO_FUNCTION', "Fonction");
define('_TO_COMPANY', "Organisation");
define('_TO_DEPARTEMENT', "Service");
define('_TO_EMAIL', "Courriel");
define('_TO_PHONE', "Téléphone");
define('_TO_ADDRESS_ADDITIONAL_1', "Point de remise");
define('_TO_ADDRESS_NUMBER', "Numéro de rue");
define('_TO_ADDRESS_STREET', "Voie");
define('_TO_ADDRESS_ADDITIONAL_2', "Complément d'acheminement");
define('_TO_ADDRESS_POSTCODE', "Code postal");
define('_TO_ADDRESS_TOWN', "Ville");
define('_TO_ADDRESS_COUNTRY', "Pays");
define('_TO_NOTES', "Annotation");
define('_TO_SECTOR', "Secteur");
define('_TO_CUSTOM_FIELD_1', "Coordonnées confidentielles");
define('_TO_CUSTOM_FIELD_2', "Coordonnées confidentielles avancée");
// END EDISSYUM - ASY01

// EDISSYUM -  ASY01 Ajout d'un connecteur E-Candidate
define('_ERROR_NAME_ECANDIDATE', "[ERREUR] Le nom ou le prenom de l'expéditeur est vite");
define('_ERROR_EMAIL_ECANDIDATE', "[ERREUR] le courriel de l'expéditeur est vite");
define('_ERROR_ADRESSE_ECANDIDATE', "[ERREUR] l'adresse de l'expéditeur est incomplete");
define('_ADD_TO_ECANDIDATE', "Document envoyé à E-Candidate avec le numéro de référence :");
// END EDISSYUM - ASY01
define('_PREFIXE_NOTE_LEXPERSONA', '[Message envoyé par');// EDISSYUM - YAA01 Ajout du connecteur lexPersona
// EDISSYUM - YAA01 Ajout du connecteur sesile
define('_SELECTED_CIRCUIT', 'Le circuit sélectionné : ');
define('_SELECTED_TYPE', 'Le type de classeur sélectionné : ');
// END EDISSYUM - YAA01

// EDISSYUM - NCH01 Module Open-Capture For MEM
define('_RECONCILIATION_AUTO_OK', 'Courrier réconcilié automatiquement, statut mis à jour');
define('_NO_ATTACHMENT_CHRONO', 'Aucune pièce jointe trouvée pour le numéro chrono');
// END EDISSYUM - NCH01

define('_ADDITIONAL_CATEGORY', 'Catégorie Additionnelle'); // EDISSYUM - LBE01 Ajout d'une nouvelle catégorie de document

// EDISSYUM - NCH01 Implémentation SerenIA
define('_SERENIA_DISABLED', 'SerenIA est désactivée. Contactez votre administrateur');
define('_SERENIA_URL_NOT_VALID', 'L\'adresse permettant de joindre SerenIA n\'est pas valide. Contactez votre administrateur');
define('_SERENIA_CREDENTIALS_NOT_VALID', 'Les informations de connexion permettant de joindre SerenIA ne sont pas valides. Contactez votre administrateur');
// END EDISSYUM - NCH01

define("_ERROR_MESSAGE_FULLTEXT_SEARCHED_VALUE_LENGTH", "Le texte recherché doit comporter au moins un mot de 3 caractères ou plus.");