...
define('_AVIS_NOTE_PREFIX', '[OPINION]'); //EDISSYUM - AMI01 Mise en majuscule de la notion d'annotation [AVIS]
...
define('_SUMMARY_SHEET_CREATION', 'Summary sheet created'); // EDISSYUM - AMO01 Dissocier les annotations par type + Adapter le paramètre defaultStatusSummarySheet
...
define('_GLOBAL_NOTES_COMMENT', 'Global notes');
define('_VISA_NOTES_COMMENT', 'Visa notes');
define('_AVIS_NOTES_COMMENT', 'Opinion notes');
// END EDISSYUM - AMO01
...
define("_NOTIFICATIONS_FORGOT_PASSWORD_SUBJECT", "[MEM Courrier] Reset password request");
define("_NOTIFICATIONS_FORGOT_PASSWORD_BODY", "Hello,<br/><br/>You requested to reset the password for your MEM Courrier account.<br/><br/>To change your password, please click on the link below :<br/>");
...
define("_NOTIFICATIONS_USER_CREATION_SUBJECT", "[MEM Courrier] Activate your user account");
define("_NOTIFICATIONS_USER_CREATION_BODY", "Welcome,<br/><br/>You have now an account to MEM Courrier.<br/><br/>To log in and set your password, please click on the link below :<br/><br/>");
...
define('_EXPORT_MODEL_MODIFICATION', "Modify the entities of the export model");
define('_TO_CIVILITY', "Civility");
define('_TO_FIRSTNAME', "First name");
define('_TO_LASTNAME', "Last name");
define('_TO_FUNCTION', "Function");
define('_TO_COMPANY', "Company");
define('_TO_DEPARTEMENT', "Department");
define('_TO_EMAIL', "Email");
define('_TO_PHONE', "Phone");
define('_TO_ADDRESS_ADDITIONAL_1', "Building");
define('_TO_ADDRESS_NUMBER', "Street number");
define('_TO_ADDRESS_STREET', "Street");
define('_TO_ADDRESS_ADDITIONAL_2', "Additional Line");
define('_TO_ADDRESS_POSTCODE', "Post code");
define('_TO_ADDRESS_TOWN', "City");
define('_TO_ADDRESS_COUNTRY', "Country");
define('_TO_NOTES', "Notes");
define('_TO_SECTOR', "Sector");
define('_TO_CUSTOM_FIELD_1', "Confidential contact information");
define('_TO_CUSTOM_FIELD_2', "Advanced Confidential Contact Information");
// END EDISSYUM - ASY01

// EDISSYUM - NCH01 Export PESv2
define('_PESV2_RESOURCE', 'PESv2 export');
define('_PESV2_RESOURCE_DESC', 'Export a file to a network folder');
define("_EXPORT_DOC", "Export of document(s)");

define("_TMP_FILE_ERROR", "Temporary file does not exist");
define ("_ERROR_WHILE_RETRIEVING_FILE", "Error retrieving the file, it does not exist or is not in PDF format");
define ("_ERROR_WHILE_RETRIEVING_ATTACHMENT_FILE", "Error retrieving attachment information from docserver");

define("_COPY_ERROR", "Error copying file to destination directory");
define("_ATTACHMENT_COPY_ERROR", "Error copying attachment to destination directory");
define("_STATUS_ERROR", "The status does not correspond to that set in the application");
define ("_PATH_ERROR", "The destination folder is not accessible");

define ("_N°", "n°");
define("_WITH_SUCCESS", "successfully completed");
define("_ERROR_CREATING_ZIP", "Error creating zip file");
define("_CONFIG_FILE_ERROR", "Error retrieving configuration information");
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Rajout de la confidentialité des contacts
define('_CONFIDENTIALITY', 'Confidential contact details');
// END EDISSYUM - NCH01

// EDISSYUM -  ASY01 Ajout d'un connecteur E-Candidate
define('_ERROR_NAME_ECANDIDATE', "[ERROR] the sender's lastname or firstname is empty");
define('_ERROR_EMAIL_ECANDIDATE', "[ERROR] the sender's email is empty");
define('_ERROR_ADRESSE_ECANDIDATE', "[ERROR] the sender's address is incomplete");
define('_ADD_TO_ECANDIDATE', "Document send to E-Candidate with following reference :");
// END EDISSYUM - ASY01
define('_PREFIXE_NOTE_LEXPERSONA', '[Message sent by');// EDISSYUM - YAA01 Ajout du connecteur lexPersona
// EDISSYUM - YAA01 Ajout du connecteur sesile
define('_SELECTED_CIRCUIT', 'The selected circuit: ');
define('_SELECTED_TYPE', 'The selected binder type: ');
// END EDISSYUM - YAA01

// EDISSYUM - NCH01 Module Open-Capture For MEM
define('_RECONCILIATION_AUTO_OK', 'Mail automatically reconciled, status updated');
define('_NO_ATTACHMENT_CHRONO', 'No attachment found with this chrono number');
// END EDISSYUM - NCH01

define('_ADDITIONAL_CATEGORY', 'Additional Category'); // EDISSYUM - LBE01 Ajout d'une nouvelle catégorie de document

// EDISSYUM - NCH01 Implémentation SerenIA
define('_SERENIA_DISABLED', 'SerenIA is disabled. Please contact your administrator.');
define('_SERENIA_URL_NOT_VALID', 'The address to contact SerenIA is not valid. Contact your administrator');
define('_SERENIA_CREDENTIALS_NOT_VALID', 'The login information to reach SerenIA is invalid. Contact your administrator.');
// END EDISSYUM - NCH01

define("_ERROR_MESSAGE_FULLTEXT_SEARCHED_VALUE_LENGTH", "The search value must contain at least one word with 3 or more characters.");