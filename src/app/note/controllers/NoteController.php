...
use SrcCore\models\DatabaseModel; // EDISSYUM - NCH01 Fix pour afficher les templates de notes en fonction de l'entitié du user et non de la destination du courrier
