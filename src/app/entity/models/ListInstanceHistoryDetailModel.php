    ...
    public static function create(array $args): bool
    {
        ...
        DatabaseModel::insert([
            ...
            'columnsValues' => [
                ...
                'old_destination'           => $args['old_destination'], // EDISSYUM - NCH01 Amélioration de l'historique de la listinstance pour l'IA
                'ai_destination'           => $args['ai_destination'] // EDISSYUM - NCH01 Amélioration de l'historique de la listinstance pour l'IA
            ]
        ]);
