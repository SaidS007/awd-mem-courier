...
use SrcCore\models\CoreConfigModel; // EDISSYUM - EME01 Afficher les dossiers dans l'ordre de création par le script de l'autofoldering
...
//                    'res_letterbox.confidentiality', // EDISSYUM - NCH01 Fix affichage des courriers confidentiels dans les dossiers
...
//                $leftJoinFunction = ['res_letterbox.status = status.id', 'res_letterbox.priority = priorities.id'];
        ...
        return $response->withJson([
            ...
            'displayFolder'     => $displayFolder ?? true  // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers  | ajouter 'displayFolder'     => $displayFolder
            ]);
    }
    ...
    public static function getScopeFolders(array $args): array
    {
        ...
        $autofolderingConfig = CoreConfigModel::getJsonLoaded(['path' => 'config/autofoldering.json']);
