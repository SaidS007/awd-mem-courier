...
abstract class MessageExchangeModelAbstract
{
     ...
     * @throws Exception
     */
    public static function getMessageByReference(array $aArgs = []): array
    {
     ...
     * @throws Exception
     */
    public static function getMessageByIdentifier(array $aArgs = []): array
    {
    ...
    public static function updateStatusMessage(array $aArgs): bool
    {
        ...
        ValidatorModel::stringType($aArgs, ['status', 'messageId']);
    ...
    public static function generateUniqueId(): string
    {
        ...
        $uniqueId = str_pad(base_convert($sec, 10, 36), 6, '0', STR_PAD_LEFT) .
            str_pad(base_convert($msec, 10, 16), 4, '0', STR_PAD_LEFT) .
            str_pad(base_convert(mt_rand(), 10, 36), 6, '0', STR_PAD_LEFT);
