...
class ContactModel
{
     ...
     * @throws Exception
     */
    public static function getByPhone(array $aArgs) : array
    {
        ...
        $aContact = DatabaseModel::select([
            ...
            'table'     => ['contacts'],
            'where'     => ["CONCAT(0,RIGHT(REGEXP_REPLACE(phone, '[^0-9]+', '', 'g'),9)) = ?", 'status <> ?'],
            'data'      => [$aArgs['phone'], 'TMP'],
            'limit'     => 1
        ]);
