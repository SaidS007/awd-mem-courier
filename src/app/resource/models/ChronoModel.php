...
class ChronoModel
{
     ...
     * @throws Exception
     */
    public static function getChronoGlobal($length): string // EDISSYUM - NCH01 Possibilité de modifier la longueur minimale du numéro de chrono | Ajout de $length
    {
     ...
     * @throws Exception
     */
    public static function getChronoEntity($entityId, $length): string // EDISSYUM - NCH01 Possibilité de modifier la longueur minimale du numéro de chrono | Ajout de $length
    {
     ...
     * @throws Exception
     */
    public static function getChronoCategory($categoryId, $length): string // EDISSYUM - NCH01 Possibilité de modifier la longueur minimale du numéro de chrono | Ajout de $length
    {
