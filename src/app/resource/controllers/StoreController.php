...
class StoreController
{
    ...
    public static function storeAttachment(array $args)
    {
        try {
            ...
            if (isset($data['attachment_type']) and $data['attachment_type'] == 'summary_sheet') {
                AttachmentModel::delete(['where' => ['res_id_master = ?', 'attachment_type = ?'], 'data' => [$data['res_id_master'], 'summary_sheet']]);
            }
            ...
            foreach ($fields as $field) {
                ...
                if (
                    ...
                    if (str_contains($field['identifier'], 'indexingCustomField_')) {
                        ...
                        if (!empty($args['customFields'][$idCustom])) {
